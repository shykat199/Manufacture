        ...
        <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
                ...
                <tr>
                    ...
                    <th class="wd-15p">Permission Key</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="button-group">
                                <a href="javascript:void(0)" data-userId="{{$permission->id}}" onclick="getUserInfo('{{$permission->id}}')"
                                   class="btn btn-secondary" data-toggle="modal" data-target="#modaldemo3">
                                    <i class="fa-solid fa-pen-to-square"></i></a>
{{--                                <a href="javascript:void(0)" class="btn btn-danger" onclick="deleteUser('{{$permission->id}}')">--}}
        ...
        function deleteUser(userId){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let userDltRoute = '{{route('admin.delete.permission',['id'=>':id'])}}'
